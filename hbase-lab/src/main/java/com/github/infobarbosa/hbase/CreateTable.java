...
public class CreateTable 
{
    ...
    public static void main( String[] args ) throws IOException
    {
        ...
        clientes.addFamily( new HColumnDescriptor("cliente") );
        clientes.addFamily( new HColumnDescriptor("endereco") );
        clientes.addFamily( new HColumnDescriptor("contato") );

        if( !admin.tableExists( clientes.getTableName() )){
            admin.createTable( clientes );
        }
    }
